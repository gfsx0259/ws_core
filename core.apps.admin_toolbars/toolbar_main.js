    ...
    renderContent: function() {
        this.buildModel(this.$["content"], [
            { tag: "a", 
              ...
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/settings.png'/></span>" },
            { tag: "a", 
              events: { onclick: "onPagesManagerClick" },
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/pages.png'/></span>" },
            { tag: "a", className: "paste_btn_bg",
              baloon_tooltip_id: 4,
              id: "btn_paste",
              events: { onmousedown: "onPasteMouseDown" },
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/clipboard.png'/></span>" },
            { tag: "a", 
              baloon_tooltip_id: 5,
              id: "btn_undo",
              events: { onclick: "onUndoClick" },
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/undo.png'/></span>" },
            { tag: "a", 
              baloon_tooltip_id: 6,
              id: "btn_redo",
              events: { onclick: "onRedoClick" },
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/redo.png'/></span>" },
            { tag: "a", 
              id: "upload",
              events: { onclick: "onUploadClick" },
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/upload.png'/></span>",
              childs: [
                { tag: "div", className: "dropdown",
                  childs: [
                    { tag: "a",
                      baloon_tooltip_id: 7,
                      id: "btn_upload_local",
                      innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/pc_small.png'/> From your computer</span>" },
                    { tag: "a",
                      baloon_tooltip_id: 8,
                      id: "btn_upload_by_url",
                      events: { onclick: "onUploadByURLClick" },
                      innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/download.png'/> From the internet</span>" }
                  ]}
              ]},
            { tag: "a", 
              baloon_tooltip_id: 10,
              events: { onclick: "onHelpClick" },
              innerHTML: "<span><img src='/vendor/generdyn/core/images/icons/help.png'/></span>" }
        ]);
